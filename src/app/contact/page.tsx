...
export default function ContactPage() {
  ...
  return (
    <>
      {/* Top Header */}
      <section className="bg-blue-100 py-10 text-center font-mont">
      ...
      {/* Form Section */}
      <section className="bg-white py-16 px-4 font-mont">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-gray-600 mb-8 max-w-xl mx-auto text-sm">
            We'd love to hear from you. Fill out the form below and we'll get back to you as soon as possible.
          </p>

          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left text-sm">
            {/* Name */}
            <div>
